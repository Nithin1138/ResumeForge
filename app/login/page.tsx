...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-bg-base text-text flex flex-col font-sans relative overflow-hidden">
      ...
      {/* Top Header */}
      <header className="glass-panel border-b border-border/40 px-6 py-4 flex items-center justify-between relative z-30">
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden md:flex items-center space-x-2 text-xs font-bold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-3.5 py-1.5 rounded-full shadow-2xs">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              ...
                              <input
                                ...
                                inputMode="numeric"
                                autoFocus
                                className="w-full pl-10 pr-4 py-2.5 rounded-xl border-2 border-primary/60 bg-bg-base text-text focus:ring-2 focus:ring-primary focus:border-primary outline-none text-sm tracking-[6px] font-mono font-extrabold transition-all"
                                placeholder="123456"
                                value={signUpOtp}
                          ...
                          <>
                            <div>
                              ...
                              {isSignUp && password.length > 0 && (
                                <div className="mt-2.5 p-2.5 bg-bg-base/70 border border-border/60 rounded-xl space-y-1.5">
