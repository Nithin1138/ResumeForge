        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-border/40 pb-5">
          ...
          <div className="flex items-center space-x-2 shrink-0">
            <button
              ...
              className="px-4 py-2 bg-primary hover:bg-primary/90 text-white text-xs font-bold rounded-xl flex items-center space-x-2 transition-all cursor-pointer shadow-sm"
              title="Check general ATS readiness using your My Space profile data"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 bg-surface hover:bg-bg-base border border-border/80 text-text text-xs font-bold rounded-xl flex items-center space-x-2 transition-all shrink-0 cursor-pointer"
            >
                  ...
                  >
                    ...
                    <div className="pt-3 border-t border-border/50 space-y-2.5">
                      <button
                        ...
                        className="w-full py-2 px-3 rounded-xl bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30 text-xs font-extrabold flex items-center justify-center space-x-2 transition-all cursor-pointer shadow-xs"
                      >
